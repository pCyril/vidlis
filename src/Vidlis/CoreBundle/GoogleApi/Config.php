...
/**
 * This class stores all the configuration information that is needed for running an Vidlis\CoreBundle\GoogleApi/Client.
...
class Config {
  ...
  static function init() {
    self::$apiConfig = array(
      ...
      'authClass'    => 'Vidlis\CoreBundle\GoogleApi\Auth\OAuth2',
      'ioClass'      => 'Vidlis\CoreBundle\GoogleApi\Io\CurlIO',
      'cacheClass'   => 'Vidlis\CoreBundle\GoogleApi\Cache\FileCache',
