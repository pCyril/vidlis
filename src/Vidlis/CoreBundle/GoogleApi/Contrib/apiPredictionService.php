...
namespace Vidlis\CoreBundle\GoogleApi\Contrib;

use Vidlis\CoreBundle\GoogleApi\Client;
use Vidlis\CoreBundle\GoogleApi\Service\Model;
use Vidlis\CoreBundle\GoogleApi\Service\Service;
use Vidlis\CoreBundle\GoogleApi\Service\ServiceResource;
...
class Input extends Model {
  protected $__inputType = 'Vidlis\CoreBundle\GoogleApi\Contrib\InputInput';
...
class Output extends Model {
  ...
  public $outputLabel;
  public $id;
  protected $__outputMultiType = 'Vidlis\CoreBundle\GoogleApi\Contrib\OutputOutputMulti';
...
class Training extends Model {
  ...
  protected $__dataAnalysisType = 'Vidlis\CoreBundle\GoogleApi\Contrib\TrainingDataAnalysis';
  protected $__dataAnalysisDataType = '';
  public $dataAnalysis;
  public $trainingStatus;
  protected $__modelInfoType = 'Vidlis\CoreBundle\GoogleApi\Contrib\TrainingModelInfo';
...
class ListModel extends Model {
  ...
  public $selfLink;
  public $items;
  protected $__itemsType = 'Vidlis\CoreBundle\GoogleApi\Contrib\Training';
  ...
  public function setItems(/* array(Webproperty) */ $items) {
    $this->assertIsArray($items, 'Vidlis\CoreBundle\GoogleApi\Contrib\Training', __METHOD__);
    $this->items = $items;
  }
