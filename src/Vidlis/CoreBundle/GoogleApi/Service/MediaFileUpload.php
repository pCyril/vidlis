...
class MediaFileUpload {
  ...
  public static function getUploadType($meta, &$payload, &$params) {
    if (isset($params['mediaUpload'])
        && get_class($params['mediaUpload']['value']) == '\Vidlis\CoreBundle\GoogleApi\\Service\\MediaFileUpload') {
  ...
  private function getResumeUri(HttpRequest $httpRequest) {
    ...
    throw new \Vidlis\CoreBundle\GoogleApi\Exception("Failed to start the resumable upload");
  }
}
