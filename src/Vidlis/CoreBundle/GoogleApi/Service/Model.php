...
class Model {
  ...
  private function createObjectFromName($name, $item) {
    $type = '\Vidlis\CoreBundle\GoogleApi\Contrib\\' . $this->$name;
  ...
  protected function assertIsArray($obj, $type, $method) {
    if ($obj && !is_array($obj)) {
      throw new \Vidlis\CoreBundle\GoogleApi\Exception("Incorrect parameter type passed to $method(), expected an"
