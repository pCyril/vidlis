 ...
 */
namespace Vidlis\CoreBundle\GoogleApi;

use Vidlis\CoreBundle\GoogleApi\Auth;
use Vidlis\CoreBundle\GoogleApi\Io;
use Vidlis\CoreBundle\GoogleApi\Cache;
use Vidlis\CoreBundle\GoogleApi;
...
class Client {
  ...
  /**
   * @var \Vidlis\CoreBundle\GoogleApi\Auth\Auth $auth
   */
  static $auth;

  /**
   * @var \Vidlis\CoreBundle\GoogleApi\Io\Io $io
   */
  static $io;

  /**
   * @static
   * @var \Vidlis\CoreBundle\GoogleApi\Cache\Cache $cache
   */
  static $cache;
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new \Vidlis\CoreBundle\GoogleApi\Exception('Cant add services after having authenticated');
    }
  ...
  /**
   * @return \Vidlis\CoreBundle\GoogleApi\Cache\Cache the implementation of Cache\Cache.
   */
