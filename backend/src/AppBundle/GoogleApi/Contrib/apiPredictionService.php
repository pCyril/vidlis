...
class Input extends Model {
  protected $__inputType = 'AppBundle\GoogleApi\Contrib\InputInput';
...
class Output extends Model {
  ...
  public $outputLabel;
  public $id;
  protected $__outputMultiType = 'AppBundle\GoogleApi\Contrib\OutputOutputMulti';
...
class Training extends Model {
  ...
  protected $__dataAnalysisType = 'AppBundle\GoogleApi\Contrib\TrainingDataAnalysis';
  protected $__dataAnalysisDataType = '';
  public $dataAnalysis;
  public $trainingStatus;
  protected $__modelInfoType = 'AppBundle\GoogleApi\Contrib\TrainingModelInfo';
...
class ListModel extends Model {
  ...
  public $selfLink;
  public $items;
  protected $__itemsType = 'AppBundle\GoogleApi\Contrib\Training';
  ...
  public function setItems(/* array(Webproperty) */ $items) {
    $this->assertIsArray($items, 'AppBundle\GoogleApi\Contrib\Training', __METHOD__);
    $this->items = $items;
  }
