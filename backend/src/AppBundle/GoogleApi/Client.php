...
use AppBundle\GoogleApi\Auth;
use AppBundle\GoogleApi\Io;
use AppBundle\GoogleApi\Cache;
use AppBundle\GoogleApi;
...
class Client {
  ...
  /**
   * @var \AppBundle\GoogleApi\Auth\Auth $auth
   */
  static $auth;

  /**
   * @var \AppBundle\GoogleApi\Io\Io $io
   */
  static $io;

  /**
   * @static
   * @var \AppBundle\GoogleApi\Cache\Cache $cache
   */
  static $cache;
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new \AppBundle\GoogleApi\Exception('Cant add services after having authenticated');
    }
  ...
  /**
   * @return \AppBundle\GoogleApi\Cache\Cache the implementation of Cache\Cache.
   */
