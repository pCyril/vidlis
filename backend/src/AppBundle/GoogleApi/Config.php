...
/**
 * This class stores all the configuration information that is needed for running an AppBundle\GoogleApi/Client.
...
class Config {
  ...
  static function init() {
    self::$apiConfig = array(
      ...
      'authClass'    => 'AppBundle\GoogleApi\Auth\OAuth2',
      'ioClass'      => 'AppBundle\GoogleApi\Io\CurlIO',
      'cacheClass'   => 'AppBundle\GoogleApi\Cache\FileCache',
